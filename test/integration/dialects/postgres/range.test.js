	...
	describe('[POSTGRES Specific] range datatype', () => {
		describe('stringify', () => {
			...
			it('should handle date values', () => {
				...
				expect(
					Range.stringify([new Date(Date.UTC(2000, 1, 1)), new Date(Date.UTC(2000, 1, 2))], {
						timezone: '+02:00',
					})
		...
		describe('stringify and parse', () => {
			it('should stringify then parse back the same structure', () => {
				...
				expect(
					DataTypes.postgres.RANGE.parse(stringified, { parser: DataTypes.postgres.INTEGER.parse })
