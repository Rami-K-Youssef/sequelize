...
describe(Support.getTestDialectTeaser('SQL'), () => {
	describe('update', () => {
		it('supports returning false', () => {
			...
			expectsql(
				sql.updateQuery(User.tableName, { user_name: 'triggertest' }, { id: 2 }, options, User.rawAttributes),
				{
					query: {
		...
		it('works with limit', () => {
			...
			expectsql(
				sql.updateQuery(User.tableName, { username: 'new.username' }, { username: 'username' }, { limit: 1 }),
				{
					query: {
