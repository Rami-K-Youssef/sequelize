		...
		const suites = {
			createDatabaseQuery: [
				...
				},
				{
					arguments: [
						'myDatabase',
						{ encoding: 'UTF8', collate: 'en_US.UTF-8', ctype: 'zh_TW.UTF-8', template: 'template0' },
					],
					expectation:
			...
			attributesToSQL: [
				...
				{
					arguments: [
						{ id: { type: 'INTEGER', primaryKey: true, autoIncrement: true, autoIncrementIdentity: true } },
					],
		...
		_.each(suites, (tests, suiteTitle) => {
			describe(suiteTitle, () => {
				...
				tests.forEach((test) => {
					...
					const title =
						test.title || `Postgres correctly returns ${query} for ${JSON.stringify(test.arguments)}`;
					it(title, function () {
