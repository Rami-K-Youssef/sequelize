		...
		const suites = {
			...
			createTableQuery: [
				...
				},
				{
					arguments: [
						'myTable',
						{ title: 'VARCHAR BINARY(255)', number: 'INTEGER(5) UNSIGNED PRIMARY KEY ' },
				...
				},
				{
					arguments: [
						'myTable',
						{ id: 'SMALLINT(4) PRIMARY KEY AUTOINCREMENT UNSIGNED', name: 'VARCHAR(255)' },
					],
					expectation:
						'CREATE TABLE IF NOT EXISTS `myTable` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `name` VARCHAR(255));',
				},
				...
				},
				{
					arguments: [
						'myTable',
						{ foo1: 'INTEGER PRIMARY KEY NOT NULL', foo2: 'INTEGER PRIMARY KEY NOT NULL' },
					],
					expectation:
						...
						function (sequelize) {
							return {
								order: [
									...
									[
										sequelize.fn('f2', 12, 'lalala', new Date(Date.UTC(2011, 2, 27, 10, 1, 55))),
										'ASC',
									],
								],
							};
