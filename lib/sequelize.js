...
class Sequelize {
	 ...
	 * @param {number}   [options.nodesCount] The number of nodes participating in a db cluster, used to handle bulkInserts in mariadb Galera Cluster
	...
	constructor(database, username, password, options) {
		...
		this.config = {
			...
			nodesCount: this.options.nodesCount,
