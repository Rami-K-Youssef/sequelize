	...
	_createForeignAndOtherKeys() {
		...
		if (_.isObject(this.options.foreignKey)) {
			...
			this.foreignKey =
				...
				Utils.camelize([this.source.options.name.singular, this.sourceKey].join('_'));
		}
	...
	_injectAttributes() {
		...
		if (this.options.constraints !== false) {
			...
			sourceAttribute.onDelete =
				this.options.onDelete || this.through.model.rawAttributes[this.foreignKey].onDelete;
			sourceAttribute.onUpdate =
				this.options.onUpdate || this.through.model.rawAttributes[this.foreignKey].onUpdate;
			...
			targetAttribute.onDelete =
				this.through.model.rawAttributes[this.otherKey].onDelete || this.options.onDelete;
			targetAttribute.onUpdate =
				this.through.model.rawAttributes[this.otherKey].onUpdate || this.options.onUpdate;
				...
				if (!existingAssociation) {
					...
					if (
						Object.keys(attributes).some(
							(attribute) => attributes[attribute] !== existingAssociation[attribute]
						)
					) {
