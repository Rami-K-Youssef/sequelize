...
class QueryInterface {
	...
	async databaseVersion(options) {
		return await this.sequelize.query(this.queryGenerator.versionQuery(), { ...options, type: QueryTypes.VERSION });
	}
	...
	async createTable(tableName, attributes, options, model) {
		...
		options = { ...options };
		console.log(_.omit(options, ['sequelize']));
		...
		sqlAttributes = this.queryGenerator.attributesToSQL(attributes, { table: tableName, context: 'createTable' });
		sql = this.queryGenerator.createTableQuery(tableName, sqlAttributes, options);
