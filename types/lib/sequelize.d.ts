...
export class Sequelize extends Hooks {
	...
	public static afterSave(fn: (instance: Model, options: UpdateOptions<any> | CreateOptions<any>) => void): void;
	...
	public static afterFind(fn: (instancesOrInstance: Model[] | Model | null, options: FindOptions<any>) => void): void;
